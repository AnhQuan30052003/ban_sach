...
<?php
	...
	function update() {
		...
		if ($result) {
			...
			echo "<script>alert('Cập nhật nhà xuất bản thất bại' . $result)</script>";
		}
	}
...
<section class="display-content" >
	...
	<form action="" method="post" class="form-container" enctype="multipart/form-data">
		...
		<div>
			...
			<input required id='typeName' type="text" id="typeName" name="typeName" value="<?php echo $type['tenNXB'] ?? "" ?>" class="form-input">
...
<script>
	// Trường typename
	window.addEventListener("load", after_leave("typeName", "error-typeName", "Tên nhà xuất bản"));
	window.addEventListener("load", change_input("typeName", "error-typeName", "Tên nhà xuất bản"));
</script>