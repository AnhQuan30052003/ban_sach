...
<script>
	// Trường typename
	window.addEventListener("load", after_leave("typeName", "error-typeName", "Tên tác giả"));
	window.addEventListener("load", change_input("typeName", "error-typeName", "Tên tác giả"));
</script>