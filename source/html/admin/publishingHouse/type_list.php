<?php
    ...
    if ($search != "") {
        $sql .= "where maNXB LIKE '%$search%' OR tenNXB LIKE '%$search%'";
    }
...
<section class='display-content'>
    <h3 >QUẢN LÝ NHÀ XUẤT BẢN</h3><hr>
    <div class="wrapper-search-add">
        <a class="btn btn-add" href="?action=create">Tạo mới</a>
        <form action="" method="GET" id="form-search">
            <input class="search-text" id="search-text" name="search" value="<?php echo $search ?? "" ?>" placeholder="Nhập mã/tên nhà xuất bản để tìm kiếm">
            <?php
                if ($search != "") {
